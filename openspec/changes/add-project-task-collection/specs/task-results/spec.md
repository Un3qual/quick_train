...
- **WHEN** an authorized export request supplies an empty key or a key longer than 128 UTF-8 bytes, including 33 four-byte Unicode characters
...
- **WHEN** an otherwise valid authorized export request uses a key of exactly 128 UTF-8 bytes, including 32 four-byte Unicode characters
