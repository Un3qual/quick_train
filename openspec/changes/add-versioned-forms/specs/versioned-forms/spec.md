...
#### Scenario: Published graph cannot change through another path
- **WHEN** a caller attempts to insert, update, delete, or reparent a child of a published version through any persistence path
