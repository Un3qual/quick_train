...
- [ ] 1.2 Generate input-slot and field-requirement resources, then add version-scoped relationships, keys, slot count bounds, single field cardinality, value-family enums matching datasets (including `utc_datetime` for UTC values), requiredness, and asset intended use.
