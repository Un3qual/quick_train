...
4. Add production request, callback, issuer, and discovered-provider-endpoint HTTPS enforcement, cleartext bearer rejection before authentication, non-cacheable credential responses, and bearer resolution to the Phoenix/Absinthe pipeline, then replace the generated schema with the explicit public allowlist.
