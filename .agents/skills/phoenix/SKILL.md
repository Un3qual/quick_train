---
name: phoenix
description: "Use when editing Phoenix endpoints, routers, plugs, controllers, channels, HTML components, LiveView, or Phoenix and Ecto integration."
metadata:
...
```sh
mix usage_rules.search_docs "search term" -p phoenix -p phoenix_ecto
```
