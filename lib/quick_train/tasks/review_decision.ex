defmodule QuickTrain.Tasks.ReviewDecision do
  ...
  relationships do
    ...
    belongs_to :predecessor, QuickTrain.Tasks.ReviewDecision,
      allow_nil?: true,
      attribute_public?: true
  end
  ...
  actions do
    action :decide, :struct do
      ...
      run {Module.concat(["QuickTrain.Tasks.QuestionReview"]), []}
    end
    ...
    action :review_batch, {:array, :struct} do
      ...
      argument :decisions, {:array, QuickTrain.Tasks.QuestionReview.Input},
        allow_nil?: false,
