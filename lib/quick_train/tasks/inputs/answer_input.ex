defmodule QuickTrain.Tasks.Inputs.AnswerInput do
  ...
  attributes do
    ...
    attribute :inputs, {:array, QuickTrain.Tasks.Inputs.TaskInputSelectionInput},
      allow_nil?: false,
      default: [],
      public?: true

    attribute :spans, {:array, QuickTrain.Tasks.Inputs.TextSpanInput},
      allow_nil?: false,
      default: [],
      public?: true
  end
