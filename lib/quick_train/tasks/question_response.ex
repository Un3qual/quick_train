defmodule QuickTrain.Tasks.QuestionResponse do
  ...
  relationships do
    has_many :static_options, QuickTrain.Tasks.StaticOptionAnswer,
      destination_attribute: :question_response_id,
      public?: true

    has_many :input_answers, QuickTrain.Tasks.TaskInputAnswer,
      destination_attribute: :question_response_id,
      public?: true

    has_many :text_spans, QuickTrain.Tasks.TextSpan,
      destination_attribute: :question_response_id,
      public?: true

    has_many :review_decisions, QuickTrain.Tasks.ReviewDecision,
      destination_attribute: :question_response_id,
      public?: true

    has_one :effective_decision, QuickTrain.Tasks.ReviewDecision do
      destination_attribute :question_response_id
      from_many? true
      sort number: :desc
      public? true
    ...
    belongs_to :response, QuickTrain.Tasks.Response,
      allow_nil?: false,
      attribute_public?: true,
      public?: true
