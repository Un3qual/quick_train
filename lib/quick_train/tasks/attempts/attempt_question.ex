defmodule QuickTrain.Tasks.Attempts.AttemptQuestion do
  ...
  calculations do
    calculate :skip_allowed,
              :boolean,
              {Module.concat(["QuickTrain.Tasks.Attempts.OfferedPolicy"]), field: :skip_allowed},
              public?: true

    calculate :reason_required,
              :boolean,
              {Module.concat(["QuickTrain.Tasks.Attempts.OfferedPolicy"]),
               field: :reason_required},
              public?: true

    calculate :review_status,
              :atom,
              {Module.concat(["QuickTrain.Tasks.Attempts.OfferedPolicy"]), field: :review_status},
              public?: true
  end
